                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="selling-product-img selling-product-img--2 d-flex align-items-center">
                                            <img class="radius-xs img-fluid" src="{{ asset('assets/img/browser/microsoft.png') }}" alt="img">
                                ...
                                <tr>
                                    <td>
                                        <div class="selling-product-img selling-product-img--2 d-flex align-items-center">
                                            <img class="radius-xs img-fluid" src="{{ asset('assets/img/browser/wordpress.png') }}" alt="img">
                                            <span>WordPress</span>
                                        </div>
                                    </td>
                                    <td>$2000,520</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="selling-product-img selling-product-img--2 d-flex align-items-center">
                                            <img class="radius-xs img-fluid" src="{{ asset('assets/img/browser/adidas.png') }}" alt="img">
                                ...
                                <tr>
                                    <td>
                                        <div class="selling-product-img selling-product-img--2 d-flex align-items-center">
                                            <img class="radius-xs img-fluid " src="{{ asset('assets/img/browser/slack.png') }}" alt="img">
                                            <span>Slack</span>
                                        </div>
                                    </td>
                                    <td>$7045,154</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="selling-product-img selling-product-img--2 d-flex align-items-center">
                                            <img class="radius-xs img-fluid" src="{{ asset('assets/img/browser/adobe.png') }}" alt="img">
                                            <span>Adobe CC</span>
                                        </div>
                                    </td>
                                    <td>$1252,220</td>
