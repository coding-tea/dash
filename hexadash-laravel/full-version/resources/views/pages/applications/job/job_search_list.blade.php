                    ...
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ trans('page_title.job_search_list') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="columns-1 col-lg-8 col-sm-10 mb-lg-0 mb-30">
                <div class="widget">
                    ...
                    <div class="category_sidebar">
                        ...
                        <aside class="product-sidebar-widget mb-30">
                            <div class="widget_title" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample1" role="button" aria-expanded="true">
                                <h6>job type</h6>
                            </div>
                            ...
                            <div class="project-icon-selected content-center mt-lg-0 mt-25">
                                <div class="listing-social-link pb-lg-0 pb-xs-2">
                                    <div class="icon-list-social d-flex">
                                        <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center  ms-xl-50  me-15" href="jobSearch.html">
                                            <img class="svg" src="{{ asset('assets/img/svg/grid.svg') }}" alt="grid"></a>
                                        <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center  active" href="jobSearchList.html">
                                ...
                                <div class="job-item px-25 py-30">
                                    <div class="card-body p-0  d-flex align-items-sm-center align-items-start flex-wrap">
                                        ...
                                        <div class="job-item__button d-flex flex-wrap my-sm-0 my-10">
                                            <button class="btn btn-default btn-squared color-none btn-outline-none px-20">View details
                                            </button>
                                        </div>
                                    </div>
                                </div>
